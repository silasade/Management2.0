        ...
        {isFetching ? (
          ...
          <div className="grid flex-1 auto-rows-min gap-6 px-4 py-2 overflow-y-auto">
            ...
            <div className="space-y-1 border-b pb-3">
              ...
              <p className="text-base text-gray-900">{data?.eventType}</p>
            </div>
            ...
            <div className="space-y-1 border-b pb-3">
              ...
              <p className="text-base text-gray-900">{data?.location}</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <p className="text-base text-gray-900">{data?.organizerName}</p>
              </div>
              <div className="space-y-1">
                <h6 className="text-sm font-semibold text-gray-700">Email</h6>
                <p className="text-base text-gray-900">
                  {data?.organizerEmail || "Not found"}
                </p>
              </div>
              <div className="space-y-1">
                <h6 className="text-sm font-semibold text-gray-700">Phone</h6>
                <p className="text-base text-gray-900">
